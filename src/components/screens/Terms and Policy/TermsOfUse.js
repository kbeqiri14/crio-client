...
const TermsOfUse = () => {
  ...
  expressed in Section 2.1. Company and its suppliers reserve all rights not granted in these Terms.`,
      ...
      [
        'User Content',
        <>
          <Text level={2}>User Content.</Text> You maintain full ownership of all creations and
          marketplace items that you offer on Crio, but we need licenses from you to operate Crio
          effectively. By posting on Crio you grant us a royalty-free, perpetual, irrevocable,
          non-exclusive, sublicensable, worldwide license to use, reproduce, distribute, perform,
          publicy display or prepare derivative works of your creation. The purpose of the license
          is strictly limited to allowing us to provide and promote to new users who may wish to
          subcribe or purchase, therefor contributing revenue to creators on the platform. We will
          never try to steal your creations or use them in an exploitative way. Crio may not use
          creations posted by creators in any way not authorized by the creator.You may not post
          creations that infringe others' intellectual property or proprietary rights.
        </>,
      ],
      <>
        <Text level={2}>Acceptable Use Policy.</Text> The following terms constitute our "Acceptable
        ...
        law, regulation, or obligations or restrictions imposed by any third party. In addition, you
        agree not to: (i) upload, transmit, or distribute to or through the Site any software
      ...
      <>
        ...
        right to assume the exclusive defense and control of any matter for which you are required
        to indemnify us, and you agree to cooperate with our defense of these claims. You agree not
      ...
      [
        ...
        <>
          <Text level={2}>Third-Party Links & Ads. </Text>
          ...
          should apply a suitable level of caution and discretion in doing so. When you click on any
          of the Third-Party Links & Ads, the applicable third party’s terms and policies apply,
          including the third party’s privacy and data gathering practices.
        </>,
      ],
      <>
        <Text level={2}>Other Users. </Text>Each Site user is solely responsible for any and all of
        its own User Content. Because we do not control User Content, you acknowledge and agree that
      ...
      <>
        ...
        debtor."
        <br />
        Cookies and Web Beacons. Like any other website, Crio Interactive uses ‘cookies’. These
      ...
      [
        ...
        <>
          ...
          of more than one claim will not enlarge this limit. You agree that our suppliers will have
          ...
          <Row gutter={[0, 30]}>
            <Col span={24} padding_top={10}>
              ...
              <Text level={3}>
                ...
                <a href='https://criointeractive.com'>https://criointeractive.com</a> is a
                copyrighted work belonging to Crio Interactive. Certain features of the Site may be
                subject to additional guidelines, terms, or rules, which will be posted on the Site
