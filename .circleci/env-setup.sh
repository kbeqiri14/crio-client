...
then
  {
    ...
    echo "export REACT_APP_COGNITO_DOMAIN=crio-staging-auth.auth.us-west-2.amazoncognito.com"
...
then
  {
    ...
    echo "export REACT_APP_COGNITO_DOMAIN=crio-production-auth.auth.us-east-1.amazoncognito.com"
    echo "export REACT_APP_FB_APP_ID=295395972481044"
