          ...
          <Row gutter={[0, 30]}>
            ...
            <Col span={24}>
              ...
              <Text level={3}>
                ...
                worldwide license to use, reproduce, distribute, perform, publicy display or prepare
                derivative works of your creation. The purpose of the license is strictly limited to
                allowing us to provide and promote to new users who may wish to subcribe or
                purchase, therefor contributing revenue to creators on the platform. We will never
                try to steal your creations or use them in an exploitative way. Crio may not use
                creations posted by creators in any way not authorized by the creator.You may not
                post creations that infringe others' intellectual property or proprietary rights.
              </Text>
            </Col>
            <Col span={24}>
              <Text level={2}>Acceptable Use Policy. </Text>
              <Text level={3}>
                ...
                hatred, or physical harm of any kind against any group or individual; (iii) that is
                harmful to minors in any way; or (iv) that is in violation of any law, regulation,
                or obligations or restrictions imposed by any third party. In addition, you agree
                not to: (i) upload, transmit, or distribute to or through the Site any software
                ...
                messages; (iii) use the Site to harvest, collect, gather or assemble information or
                data regarding other users without their consent; (iv) interfere with, disrupt, or
            ...
            <Col span={24}>
              <Text level={4}>Third-Party Links & Ads; Other Users</Text>
              <br />
            ...
            <Col span={24}>
              ...
              <Text level={3}>
                ...
                responsible for any User Content, whether provided by you or by others. You agree
                that Company will not be responsible for any loss or damage incurred as the result
                of any such interactions. If there is a dispute between you and any Site user, we
            ...
            <Col span={24}>
              <Text level={3}>
                ...
                debtor."
                <br />
                Cookies and Web Beacons. Like any other website, Crio Interactive uses ‘cookies’.
                These cookies are used to store information including visitors’ preferences, and the
                pages on the website that the visitor accessed or visited. The information is used
                to optimize the users’ experience by customizing our web page content based on
                visitors’ browser type and/or other information.
              </Text>
            </Col>
            <Col span={24}>
              <Text level={4}>Disclaimers</Text>
              <br />
              <Text level={3}>
            ...
            <Col span={24}>
              <Text level={4}>Limitation on Liability</Text>
              <br />
              <Text level={3}>
