        ...
        <Row gutter={[0, 20]}>
          ...
          <Col span={24}>
            ...
            <ul style={{ color: 'white' }}>
              <li>
                <Text level={3}>Republish material from Crio Interactive</Text>
              </li>
              <li>
                <Text level={3}>Sell, rent or sub-license material from Crio Interactive</Text>
              </li>
              <li>
                <Text level={3}>Reproduce, duplicate or copy material from Crio Interactive</Text>
              </li>
              <li>
                <Text level={3}>Redistribute content from Crio Interactive</Text>
              </li>
            </ul>
          ...
          <Col span={24}>
            <Text level={3}>
              ...
              information in certain areas of the website. Crio Interactive does not filter, edit,
              publish or review Comments prior to their presence on the website. Comments do not
              reflect the views and opinions of Crio Interactive,its agents and/or affiliates.
          ...
          <Col span={24}>
            <Text level={3}>
              Crio Interactive reserves the right to monitor all Comments and to remove any Comments
          ...
          <Col span={24}>
            ...
            <Text level={3}>
              You hereby grant Crio Interactive a non-exclusive license to use, reproduce, edit and
          ...
          <Col span={24}>
            ...
            <ul style={{ color: 'white' }}>
              <li>
                <Text level={3}>Government agencies;</Text>
              </li>
              <li>
                <Text level={3}>Search engines;</Text>
              </li>
              <li>
                <Text level={3}>News organizations;</Text>
              </li>
              <li>
                <Text level={3}>
          ...
          <Col span={24}>
            ...
            <ul style={{ color: 'white' }}>
              <li>
                <Text level={3}>commonly-known consumer and/or business information sources;</Text>
              </li>
              <li>
                <Text level={3}>dot.com community sites;</Text>
              </li>
              <li>
                <Text level={3}>associations or other groups representing charities;</Text>
              </li>
              <li>
                <Text level={3}>online directory distributors;</Text>
              </li>
              <li>
                <Text level={3}>internet portals;</Text>
              </li>
              <li>
                <Text level={3}>accounting, law and consulting firms; and</Text>
              </li>
              <li>
                <Text level={3}>educational institutions and trade associations.</Text>
              </li>
            </ul>
            <Text level={3}>
              ...
              from the visibility of the hyperlink compensates the absence of Crio Interactive; and
          ...
          <Col span={24}>
            <Text level={3}>
              ...
              linking to our website, you must inform us by sending an e-mail to Crio Interactive.
          ...
          <Col span={24}>
            ...
            <ul style={{ color: 'white' }}>
              <li>
                <Text level={3}>By use of our corporate name; or</Text>
              </li>
              <li>
                <Text level={3}>By use of the uniform resource locator being linked to; or</Text>
              </li>
              <li>
                <Text level={3}>
            ...
            <Text level={3}>
              No use of Crio Interactive's logo or other artwork will be allowed for linking absent
              a trademark license agreement.
            </Text>
          </Col>
          <Col span={24}>
            <Title level={2}>iFrames</Title>
          </Col>
          <Col span={24}>
            <Text level={3}>
          ...
          <Col span={24}>
            <Title level={2}>Content Liability</Title>
          </Col>
          <Col span={24}>
            <Text level={3}>
          ...
          <Col span={24}>
            <Title level={2}>Reservation of Rights</Title>
          </Col>
          <Col span={24}>
            <Text level={3}>
          ...
          <Col span={24}>
            <Title level={2}>Removal of links from our website</Title>
          </Col>
          <Col span={24}>
            <Text level={3}>
